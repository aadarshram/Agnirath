...
def main():
    ...
    distances1 = np.cumsum(route_df['dist'])
    ...
    def obj(x_in):
        ...
        for i in range(n_v-1):
            # print("hi")
            sim1 = car.drive_sim(x_in[i],x_in[i+1], (x_in[i+1] - x_in[i])/(route[i][0]/x_in[i]), battery_capacity-E_use, route_df.iloc(i, 0), route_df.iloc(i, 1))
            t_arr.append(sim1[0])
            E_use += sim1[4]
