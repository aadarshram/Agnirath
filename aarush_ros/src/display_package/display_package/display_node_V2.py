...
class MainWindow(QMainWindow):
    def __init__(self, parent=None):
        ...
        self.telemetry_label.setGeometry(QRect(355, 28, 450, 65))
        ...
        self.radio_label.setGeometry(QRect(199, 122, 222, 41))
        self.radio_label.setAlignment(Qt.AlignCenter)
        self.radio_label.setStyleSheet("font-family: 'Red Rose'; font-size: 30px; font-weight: 400; "
                              "line-height: 48px; letter-spacing: 0em; color: #FFFFFF; "
                              "background-color: #161F28")
        ...
        self.transmit_label.setGeometry(QRect(199, 181, 222, 41))
        self.transmit_label.setAlignment(Qt.AlignCenter)
        self.transmit_label.setStyleSheet("font-family: 'Red Rose'; font-size: 30px; font-weight: 400; "
                              "line-height: 48px; letter-spacing: 0em; color: #FFFFFF; "
                              "background-color: #161F28")
        self.transmit_label.setText("Transmitting")
        self.transmit_label.hide()

        self.receive_label = QLabel(self)
        self.receive_label.setGeometry(QRect(199, 240, 222, 41))
        self.receive_label.setAlignment(Qt.AlignCenter)
        self.receive_label.setStyleSheet("font-family: 'Red Rose'; font-size: 30px; font-weight: 400; "
                              "line-height: 48px; letter-spacing: 0em; color: #FFFFFF; "
                              "background-color: #161F28")
        self.receive_label.setText("Receiving")
        self.receive_label.hide()

        self.rfrssi_label = QLabel(self)
        self.rfrssi_label.setGeometry(QRect(199, 299, 222, 41))
        self.rfrssi_label.setAlignment(Qt.AlignCenter)
        self.rfrssi_label.setStyleSheet("font-family: 'Red Rose'; font-size: 30px; font-weight: 400; "
                              "line-height: 48px; letter-spacing: 0em; color: #FFFFFF; "
                              "background-color: #161F28")
        self.rfrssi_label.setText("RF RSSI")
        self.rfrssi_label.hide()

        self.snr_label = QLabel(self)
        self.snr_label.setGeometry(QRect(199, 358, 222, 41))
        self.snr_label.setAlignment(Qt.AlignCenter)
        self.snr_label.setStyleSheet("font-family: 'Red Rose'; font-size: 30px; font-weight: 400; "
                              "line-height: 48px; letter-spacing: 0em; color: #FFFFFF; "
                              "background-color: #161F28")
        ...
        self.msgrec_label.setGeometry(QRect(199, 417, 222, 72))
        self.msgrec_label.setAlignment(Qt.AlignCenter)
        self.msgrec_label.setStyleSheet("font-family: 'Red Rose'; font-size: 30px; font-weight: 400; "
                              "line-height: 48px; letter-spacing: 0em; color: #FFFFFF; "
                              "background-color: #161F28")
        self.msgrec_label.setText("Message\nRecived ")
        self.msgrec_label.hide()

        self.msgsent_label = QLabel(self)
        self.msgsent_label.setGeometry(QRect(199, 507, 222, 72))
        self.msgsent_label.setAlignment(Qt.AlignCenter)
        self.msgsent_label.setStyleSheet("font-family: 'Red Rose'; font-size: 30px; font-weight: 400; "
                              "line-height: 48px; letter-spacing: 0em; color: #FFFFFF; "
                              "background-color: #161F28")
        ...
        self.radiost_label.setGeometry(423,116,221,52)
        self.radiost_label.hide()
        self.transt_label = QLabel(self)
        self.transt_label.setGeometry(423,175,221,52)
        self.transt_label.hide()
        self.recst_label = QLabel(self)
        self.recst_label.setGeometry(423,234,221,52)
        self.recst_label.hide()

        self.rssi_fr = QLabel(self)
        self.rssi_fr.setGeometry(423,293, 221, 52)
        self.rssi_fr.hide()
        self.snr_fr = QLabel(self)
        self.snr_fr.setGeometry(423,355, 221, 52)
        self.snr_fr.hide()
        self.msgrec_fr = QLabel(self)
        self.msgrec_fr.setGeometry(423,430, 585, 52)
        self.msgrec_fr.hide()
        self.msgsent_fr = QLabel(self)
        self.msgsent_fr.setGeometry(423,517, 585, 52)
        self.msgsent_fr.hide()
    ...
    def hide(self):
        ...
        if self.button9_clicked:
            ...
            self.telemetry_ul.show()
            self.radio_label.show()
            self.transmit_label.show()
            self.receive_label.show()
            self.rfrssi_label.show()
            self.snr_label.show()
            self.msgrec_label.show()
            self.msgsent_label.show()
            self.radiost_label.show()
            self.recst_label.show()
            self.transt_label.show()
            self.rssi_fr.show()
            self.snr_fr.show()
            self.msgrec_fr.show()
            self.msgsent_fr.show()
            self.camera_label.hide()
            self.cam.stop()
            self.dist_label.hide()
            self.time_label.hide()
    ...
    def display_image(self):
        ...
        painter_msgsent.end()
        self.msgsent_fr.setPixmap(pixmap_msgsent.scaled(585, 52))
