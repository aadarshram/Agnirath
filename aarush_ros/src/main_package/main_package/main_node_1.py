    ...
    while rclpy.ok():
        ...
        if can_sub_data is not None:
            ...
            if can_sub_data[0] == mppt_1_base_address + 6:
                ...
                final_data[mppt_1_fd_index + 30:mppt_1_fd_index + 32] = can_sub_data[1:3]
            ...
            if can_sub_data[0] == mppt_2_base_address + 5:
                ...
                final_data[mppt_2_fd_index + 10:mppt_2_fd_index + 30] = can_sub_data[1:22]
            
            # Power Connector
            if can_sub_data[0] == mppt_2_base_address + 6:
                parsed_data[mppt_2_index+24:mppt_2_index+26] = can_sub_data[1:3]
                final_data[mppt_2_fd_index + 30:mppt_2_fd_index + 32] = can_sub_data[1:3]
            ...
            if can_sub_data[0] == mppt_3_base_address + 5:
                ...
                final_data[mppt_3_fd_index + 10:mppt_3_fd_index + 30] = can_sub_data[1:22]
            
            # Power Connector
            if can_sub_data[0] == mppt_3_base_address + 6:
                parsed_data[mppt_3_index+24:mppt_3_index+26] = can_sub_data[1:3]
                final_data[mppt_3_fd_index + 30:mppt_3_fd_index + 32] = can_sub_data[1:3]
            ...
            if can_sub_data[0] == mppt_4_base_address + 5:
                ...
                final_data[mppt_4_fd_index + 10:mppt_4_fd_index + 30] = can_sub_data[1:21]
