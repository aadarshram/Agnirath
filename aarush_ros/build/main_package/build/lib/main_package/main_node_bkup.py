...
def main(args=None):
    ...
    while rclpy.ok():
        ...
        mc_base_address = 0x400 # Will change this later after updating the correct base address
        ...
        if can_sub_data is not None:
            ...
            #  Status - 17 strings for controls are 8 X "error flags", 8 X "limit flags" and 1X"mode"
            ...
            #  Status - 17 strings for controls are 8-"error flags", 8-"limit flags" and 1-"mode"
            ...
            if can_sub_data[0] == mc_base_address + 0x09:
                parsed_data[mc_index+15:mc_index+17] = can_sub_data[1:3]

            # Heat Sink and Motor Temperature
            if can_sub_data[0] == mc_base_address + 0x0B:
                parsed_data[mc_index+17:mc_index+19] = can_sub_data[1:3]

            # DSP Board Temperature
            if can_sub_data[0] == mc_base_address + 0x0C:
                parsed_data[mc_index+19] = can_sub_data[1]
